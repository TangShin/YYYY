...
@interface YYYAttributeLabelView () <TTTAttributedLabelDelegate>
...
@implementation YYYAttributeLabelView
...
- (void)attributedLabel:(TTTAttributedLabel *)label didSelectLinkWithURL:(NSURL *)url {
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(YYYAttributeLabelView:linkFlag:)]) {
        
        [_delegate YYYAttributeLabelView:self linkFlag:url.absoluteString];
    }
}
